...
public class ModelAction {
	...
	public static List<Model> searchRunningOutModels(final int minQuantity) throws SQLException{
		DBConnection conn = new DBConnection();

		List<Model> res = new ArrayList<>();
		String query = "SELECT * FROM models WHERE UnitInStock <= " +minQuantity +" ORDER BY UnitInStock;";
		PreparedStatement preparedStmt = conn.getMySQLConnection().prepareStatement(query);
